...
fn test24() {
    ...
    // Вызов метода `fly` из трейта `Pilot`
    assert_eq!(Pilot::fly(&person), "This is your captain speaking.");
    // Вызов метода `fly` из трейта `Wizard`
    assert_eq!(Wizard::fly(&person), "Up!");
    // Вызов метода `fly`, реализованного непосредственно в структуре `Human`
...
// Person является супертрейтом для Student, поэтому нужно реализовать его
...
// CompSciStudent — субтрейтом для Programmer и Student, поэтому оба нужно реализовать
...
// Определение структуры CSStudent
struct CSStudent {
    name: String,
    university: String,
    fav_language: String,
...
// Реализация трейта Person для CSStudent
...
// Реализация трейта Student для CSStudent
...
// Реализация трейта Programmer для CSStudent
...
// Реализация трейта CompSciStudent для CSStudent
